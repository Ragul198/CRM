...
import { updateLeadStatus } from "../api/fetchdata.jsx"; // ✅ Use the same API you used in Leads
...
const Enquiry = () => {
  ...
  // Local states for pagination and search/filter
  ...
  // Filter for leads with status 'Enquiry'
    ...
    <div id="table-width-fixed" className="mt-4">
      ...
      <div className="mt-4">
        <div className="flex flex-row gap-4 items-center">
          ...
          />
          <p className="text-gray-700 font-extrabold text-2xl">Enquiry Leads</p>
        </div>
                ...
                paginatedLeads.map((lead) => (
                  <tr key={lead._id} className="hover:bg-gray-50">
                    <td className="p-3 border-b text-blue-700 border-gray-300">
                       <Link to={`/opportunityView/${lead._id} `} state={{ fromSection: "enquiry" }}>{lead.name}</Link>
                    </td>
                    ...
                    {/* Status Dropdown - persists to DB */}
                    <td className="p-3 border-b border-gray-300">
                      ...
                      >
                        ...
                        {[lead.status, "Quotation","Follow-up", "Failed"]
