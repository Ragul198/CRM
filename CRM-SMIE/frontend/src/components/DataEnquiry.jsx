          ...
          <tbody>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="p-3 border-b border-gray-300 text-blue-700">
                  <Link to={'/enquiryView'}>{"leadName"}</Link>
                </td>
                ...
                <td className="p-3 border-b border-gray-300 ">
                  <div className="bg-pink-200 text-pink-900 rounded-full max-w-fit px-2">
              ...
              <tr>
                <td className="p-4 border-b border-gray-300 text-gray-700 text-center" colSpan={6}>
                  No Enquiry Data Available
                </td>
              </tr>
