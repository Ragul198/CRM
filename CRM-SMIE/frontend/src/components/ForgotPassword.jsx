  ...
  return (
    <div className="bg-gray-200 bg-opacity-30 fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white w-md rounded-xl p-7 shadow-lg mx-3">
        ...
        <h1 className="text-3xl font-bold text-orange-600 text-center">Forgot Password</h1>
        ...
        <div className="mt-5 flex flex-col gap-3">
            ...
            <button 
              ...
              type='button'
              onClick={()=>!loading && handleSendEmail(email)}
            >
              {loading ? "Loading..." : <>Send Email</>}
            </button>

            <div className='text-end mt-3'>
                <Link to='/login' className='text-orange-600 cursor-pointer'>Have an account, SignIn!</Link>
            </div>  
